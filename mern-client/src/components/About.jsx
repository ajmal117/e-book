            ...
            <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
              <div className="relative lg:max-w-md">
                <img
                  src={ajmalPic}
                  alt="aboutimage"
                  className="relative z-10 object-cover w-full h-96  shadow-md rounded-lg"
                />
                <div className="absolute bottom-0 right-0 z-10 p-8 bg-white border-4 border-blue-500 rounded-lg shadow dark:border-blue-400 lg:-mb-8 lg:-mr-11 sm:p-8 dark:text-gray-300 dark:bg-gray-800 ">
                  <p className="text-lg font-semibold md:w-72 ">
                    ...
                    A Way To Open Opportunity For Reader And Writer
                  </p>
                </div>
              </div>
            </div>
